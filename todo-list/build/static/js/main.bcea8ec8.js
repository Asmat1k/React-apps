/*! For license information please see main.bcea8ec8.js.LICENSE.txt */
!(function () {
  'use strict';
  var e = {
      463: function (e, n, t) {
        ...
        function Kn(e, n, t, r) {
          if (Wn) {
            var l = Xn(e, n, t, r);
            if (null === l) Hr(e, n, r, Yn, t), Mn(e, r);
            else if (
              (function (e, n, t, r, l) {
                switch (n) {
                  case 'focusin':
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = n.return), 0 === (32768 & n.flags))) {
              if (null !== (t = Ku(t, n, Ri))) return void (Li = t);
            } else {
              if (null !== (t = Yu(t, n)))
  ...
  !(function () {
    ...
    var b = function (n) {
        var t = n.style,
          r = n.text,
          l = n.onClick,
          a = (0, e.useContext)(y).saveInLocalStorage;
      ...
      k = 'form_error__tcP7C',
      w = 'form_form__7ggY6',
      S = 'form_button__ZUdqH',
      x = 'myInput_input__yWlYN';
    var _ = function (e) {
      var n = e.type,
        t = e.placeholder,
        r = e.value,
    ...
    var E = function () {
        var n = f(
          ...
          a = l[0],
          o = l[1],
          i = (0, e.useContext)(y).createToDoItem;
        return (0, v.jsxs)('div', {
          className: '',
          children: [
            a.length < 0
              ? ''
              : (0, v.jsx)('div', { className: k, children: a }),
            (0, v.jsxs)('form', {
              className: w,
              children: [
                (0, v.jsx)(_, {
                  ...
                  value: t.title,
                  onChange: function (e) {
                    return r(u(u({}, t), {}, { title: e.target.value }));
                  },
                }),
                (0, v.jsx)(_, {
                  type: 'text',
                  ...
                  value: t.text,
                  onChange: function (e) {
                    return r(u(u({}, t), {}, { text: e.target.value }));
                  },
                }),
                (0, v.jsx)(_, {
                  type: 'text',
                  ...
                  value: t.time,
                  onChange: function (e) {
                    return r(u(u({}, t), {}, { time: e.target.value }));
                  },
                }),
                (0, v.jsx)(b, {
                  text: 'ADD',
                  ...
                  onClick:
                    t.title && t.text
                      ? function (e) {
                          e.preventDefault();
                          var n = u({ id: Date.now() }, t);
                          i(n),
                            r({ isDone: !1, title: '', text: '', time: '' }),
                            o('');
                        }
                      : function (e) {
                          e.preventDefault(),
                            a.length <= 0 &&
                              o('fields with * must be filled in!');
                        },
                }),
              ],
            }),
    ...
    var P = function (n) {
      var t = n.todo,
        r = n.myKey,
        l = f((0, e.useState)(t), 2),
        a = l[0],
        o = l[1],
        i = f((0, e.useState)(t.isDone), 2),
        s = (i[0], i[1]),
        c = f((0, e.useState)(!1), 2),
        d = c[0],
        p = c[1];
      console.log(a);
      var m = (0, e.useContext)(y),
        h = m.changeToDoItem,
        g = m.removeToDoItem;
      return (0, v.jsxs)(
        'div',
            ...
            d
              ? (0, v.jsxs)('div', {
                  ...
                  children: [
                    (0, v.jsx)(_, {
                      ...
                      value: a.title,
                      onChange: function (e) {
                        return o(u(u({}, a), {}, { title: e.target.value }));
                      },
                    }),
                    (0, v.jsx)(_, {
                      type: 'text',
                      ...
                      value: a.text,
                      onChange: function (e) {
                        return o(u(u({}, a), {}, { text: e.target.value }));
                      },
                    }),
                    (0, v.jsx)(_, {
                      type: 'text',
                      ...
                      value: a.time,
                      onChange: function (e) {
                        return o(u(u({}, a), {}, { time: e.target.value }));
                      },
                    }),
                  ],
                })
              : (0, v.jsx)('div', {
                  ...
                  children: (0, v.jsxs)('div', {
                    className: ''.concat(N.info),
                    children: [
                      (0, v.jsx)('h2', {
                        className: N.title,
                        children: t.title,
                      }),
                      (0, v.jsx)('p', { className: N.text, children: t.text }),
                      (0, v.jsx)('p', {
                        className: N.time,
                        children: t.time ? a.time : '',
                      }),
                    ],
                  }),
                }),
    ...
    var z = function () {
      var n = (0, e.useContext)(y).toDoList;
      return (
        console.log(n),
        (0, v.jsx)('div', {
          className: C,
          children: n.map(function (e, n) {
            return (0, v.jsx)(P, { todo: e, myKey: n }, n);
          }),
        })
      );
    };
      ...
      return (0, v.jsx)(y.Provider, {
        value: {
          ...
          changeToDoItem: function (e, n, t) {
            ...
            } else l([].concat(c(r.slice(0, a)), [n], c(r.slice(a + 1))));
          },
        },
        children: (0, v.jsxs)('main', {
          ...
          children: [
            ...
            (0, v.jsx)(E, {}),
            r.length
              ? (0, v.jsx)('div', { children: (0, v.jsx)(z, {}) })
              : (0, v.jsx)('div', { className: p, children: 'Nothing to do' }),
            (0, v.jsx)(b, { text: 'save', style: m }),
          ],
        }),
      });
    };
...
//# sourceMappingURL=main.bcea8ec8.js.map
